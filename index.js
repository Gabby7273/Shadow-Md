 ...
 * @author : Gideon <https://github.com/Gabby7273>
...
const sessdata = config.SESSION_ID.replace("SHADOW-MD~", '');
...
console.log('SHADOW-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ SHADOW-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
if(senderNumber.includes("233532871325")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("233532871325")){
